...
namespace QuIsec_Client
{
    public interface IGameView : IView
    {
        ...
        int Time { set; }
        void ShowRightAnswerThreadSafe(string currentQuestRightAnswer);
        void ChangedTeamInformationThreadSafe(Team[] teams);
        void SetTimeThreadSafe(int remainTime);
        void SetQuestThreadSafe(Question quest);
    }
}